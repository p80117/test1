...
//Error number for driver API
   ...
   //AD Range
    public const ushort LC_B_0_2_V = 0;
...
/*---------------------------------------------------------------------------*/
    ...
    [DllImport("PCI-Dask.dll")]
    public static extern short AI_ContReadChannel(ushort CardNumber, ushort Channel, ushort AdRange, uint[] Buffer, uint ReadCount, double SampleRate, ushort SyncMode);
    [DllImport("PCI-Dask.dll")]
    ...
    [DllImport("PCI-Dask.dll")]
    public static extern short AI_ContReadChannel(ushort CardNumber, ushort Channel, ushort AdRange, out ushort Buffer, uint ReadCount, double SampleRate, ushort SyncMode);
    [DllImport("PCI-Dask.dll")]
    ...
    [DllImport("PCI-Dask.dll")]
    public static extern short AI_EventCallBack (ushort CardNumber, short mode, short EventType, MulticastDelegate callbackAddr);
    [DllImport("PCI-Dask.dll")]
...
/*---------------------------------------------------------------------------*/
    ...
    [DllImport("PCI-Dask.dll")]
    public static extern short AO_EventCallBack (ushort CardNumber, short mode, short EventType, MulticastDelegate callbackAddr);
    [DllImport("PCI-Dask.dll")]
...
/*---------------------------------------------------------------------------*/
    ...
    [DllImport("PCI-Dask.dll")]
    public static extern short GPTC_EventCallBack (ushort CardNumber, short Enabled, short EventType, MulticastDelegate callbackAddr);
    [DllImport("PCI-Dask.dll")]
